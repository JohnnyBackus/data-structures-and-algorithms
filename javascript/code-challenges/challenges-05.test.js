...
const checkValues = (obj, value) => {
  ...
  // let trueOrFalse = '';
  // const valueCheck = (val === value)? trueOrFalse = true : trueOrFalse = false;
...
const getHouses = (arr) => {
  let houses = [];
  arr.forEach((obj) => {
  //   houses.push(Object.values(obj.house));
  // });
    // for (let i=0; i < arr.length; i++) {
  //   if (Object.keys(obj) === 'houses') {
  //     houses.push(Object.values(obj));
  //   }
  // });
  // console.log(houses);
